...
public class AccountControllerBootTests {
	...
	public void accountDetailsFail() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/accounts/9999", (Object) null));
	...
	public void createAccount() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/accounts", (Object) null)
		.contentType(MediaType.APPLICATION_JSON)
		.content(asJsonString(testAccount)))
		.andExpect(status().isCreated())
		.andExpect(header().stringValues("Location", "http://localhost/accounts/21"));
